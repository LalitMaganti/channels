...
class IndexedMapChangeRegistry<T : ObservableIndexedMap<K, V>, K, V> :
        CallbackRegistry<ObservableIndexedMap.OnIndexedMapChangedCallback<T, K, V>, T, IndexedMapChangeRegistry.MapChanges<K, V>>(
                NOTIFIER_CALLBACK as NotifierCallback<ObservableIndexedMap.OnIndexedMapChangedCallback<T, K, V>, T, MapChanges<K, V>>) {
    ...
    companion object {
        private val NOTIFIER_CALLBACK = object :
                NotifierCallback<ObservableIndexedMap.OnIndexedMapChangedCallback<ObservableIndexedMap<Any, Any>, Any, Any>, ObservableIndexedMap<Any, Any>, MapChanges<Any, Any>>() {
